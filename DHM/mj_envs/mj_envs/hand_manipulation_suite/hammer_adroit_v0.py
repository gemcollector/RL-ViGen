...
class HammerAdroitEnvV0(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        ...
        mujoco_env.MujocoEnv.__init__(self, curr_dir+f'/assets/adroit/DAPG_hammer_test_{str(os.getpid())}.xml', 5)
        # mujoco_env.MujocoEnv.__init__(self, curr_dir + '/assets/adroit/hammer_adroit.xml', 5)
        ...
        self.S_grasp_sid = self.sim.model.site_name2id('S_grasp')  # adroit
    ...
    def step(self, a):
        ...
        palm_pos = self.data.site_xpos[self.S_grasp_sid].ravel()  # dhm
