...
class HammerBarrettEnvV0(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        ...
        mujoco_env.MujocoEnv.__init__(self, curr_dir+f'/assets/barrett/DAPG_hammer_test_{str(os.getpid())}.xml', 5)
