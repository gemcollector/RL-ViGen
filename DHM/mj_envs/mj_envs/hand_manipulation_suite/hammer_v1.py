...
class HammerEnvV1(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        ...
        mujoco_env.MujocoEnv.__init__(self, curr_dir + '/assets/mpl/DAPG_hammer_test.xml', 5)
        utils.EzPickle.__init__(self)

        # change actuator sensitivity  # TODO
        ...
        self.S_grasp_sid = self.sim.model.site_name2id('S_grasp')  # dhm
