...
class Env:
    ...
    def __init__(
        ...
        # self._sim.ctrl_freq = self._config.simulator.ctrl_freq
    ...
    def reset(self) -> Observations:
        ...
        # self._task.measurements.update_measures(  # TODO GVRLB
        #     episode=self.current_episode,
        #     action=np.zeros(self.action_space.spaces['velocity_control'].n),
        #     task=self.task,
        #     observations=observations,
        # )
