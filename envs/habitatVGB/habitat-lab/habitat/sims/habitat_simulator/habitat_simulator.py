...
class HabitatSim(habitat_sim.Simulator, Simulator):
    ...
    def __init__(self, config: DictConfig) -> None:
        ...
        self.sim_config.sim_cfg.scene_light_setup = habitat_sim.gfx.DEFAULT_LIGHTING_KEY
        self.sim_config.sim_cfg.override_scene_light_defaults = True
    ...
    def super_reconfigure(self, cfg):
